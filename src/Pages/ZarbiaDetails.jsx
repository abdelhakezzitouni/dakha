...
function ZarbiaDetails() {

  const id = useParams();
  const pro = ZarbiaData.filter(y=>y.slug == id.slug);
  const item = pro[0];
  ...
  return (
    <div className='flex flex-col md:flex-row md:items-start items-center'>
      <div className='md:w-1/2 w-full flex md:justify-end justify-center md:pr-16'>
        <img src={item.img} className='h-96' />
      </div>
      <div  className='md:w-1/2 w-full pl-5 md:pt-10 pt-5 '>
